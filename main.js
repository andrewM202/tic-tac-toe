...
function change(element) {
  ...
  if (firstTurn) {
    /* If its first turn, have it be random whether O or X goes first */
    if (this.firstChild.textContent === "") {
      /* It checks this.firstChild since that is the <p> */
    ...
    /* If its not first turn, alternate between X and O */
    if (OsTurn === true) {
